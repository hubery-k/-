...
void USE_LED()
{
	...
	if(LED_Enable==0)
	{
		...
		if(adc_value<1.5){L3=1;}
		else if(adc_value>=1.5 && adc_value<2.5){L3=0;}
		else if(adc_value>=2.5 && adc_value<3.5){L3=1;}
		else if(adc_value>=3.5){L3=0;}
		
		if(F<1000){L4=1;}
		else if(F>=1000 && F<5000){L4=0;}
		else if(F>=5000 && F<10000){L4=1;}
		else if(F>=10000){L4=0;}
